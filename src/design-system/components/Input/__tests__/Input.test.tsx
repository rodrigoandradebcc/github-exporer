...
describe('Input', () => {
  it('renders with label', () => {
    renderWithTheme(<Input label="Email" value="" onChangeText={jest.fn()} testID="input" />);
    expect(screen.getByText('Email')).toBeTruthy();
  });

  it('calls onChangeText on input', () => {
    const onChangeText = jest.fn();
    renderWithTheme(<Input value="" onChangeText={onChangeText} testID="input" />);
  ...
  it('shows error message when error prop provided', () => {
    renderWithTheme(
      <Input value="" onChangeText={jest.fn()} testID="input" error="This field is required" />,
    );
  ...
  it('shows helper text when no error', () => {
    renderWithTheme(
      <Input value="" onChangeText={jest.fn()} testID="input" helperText="Max 100 characters" />,
    );
